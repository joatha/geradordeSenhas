...
class PassGen:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('Quantidade de caracterres'), sg.Combo(values=list(
                range(30)), key='total_chars', default_value=1, size=(3, 1))],
            [sg.Output(size=(32, 5))],
            [sg.Button('Gerar Senha')]
        ]

        # Gerar janela da aplicação
    ...
    def gerar_senha(self, valores):
        char_list = 'ABCDEFGHIJLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890!@#$%&*'
